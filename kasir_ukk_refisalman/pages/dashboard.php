...
$sql_petugas = "SELECT COUNT(*) as count FROM petugas";
$result_petugas = $conn->query($sql_petugas);
$count_petugas = $result_petugas->fetch_assoc()['count'];
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="card text-white mb-3 shadow rounded" style="background-color: #342d76;">
                        <div class="card-body">
                            <h4 class="card-title"><i class="bi bi-people-fill"></i> Jumlah Petugas</h4>
                            <h1 class="card-text text-left">
                                <?php echo $count_petugas ?? 0; ?>
                            </h1>
                        </div>
                    </div>
                </div>
