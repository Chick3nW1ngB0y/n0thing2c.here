...
<header>
    ...
    <nav>
        <ul class="nav nav-pills">
            ...
            <li class="nav-item">
                <a class="nav-link <?php echo $current_page == 'data_penjualan.php' ? 'active' : ''; ?>" href="../pages/data_penjualan.php">Data Penjualan</a>
            </li>
            <li class="nav-item">
                <a class="nav-link <?php echo $current_page == 'kelola_user.php' ? 'active' : ''; ?>" href="../pages/kelola_user.php">Kelola User</a>
            </li>
            <li class="nav-item">
