...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 14, 2025 at 06:05 AM
...
(2, NULL, 19, 101, 1, '2025-04-14 11:00:14');
...
(17, '2025-04-14', 1999000.00, 0),
(18, '2025-04-14', 1999000.00, 0),
(19, '2025-04-14', 1999000.00, 0);
...
(54, 'Charles Manullang', 'admun', '1234', 'admin');
...
(101, 'Akun HSR Acheron Jiaoqiu E6S5', 1999000.00, 1),
(58147347, 'Pol', 13000.00, 2);
...
--
ALTER TABLE `petugas`
  MODIFY `PetugasID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;
COMMIT;
